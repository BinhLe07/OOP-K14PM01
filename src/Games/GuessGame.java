    ...
    void StartGame()
    {
        ...
        while(true)
        {
            ...
            if(p1listRight || p2listRight || p3listRight)// Nếu có ít nhất 1 người đoán đúng (|| là toán tử hoặc)
            {
                ...
                System.out.println("Player one got it right (Player 1) ?"+ p1listRight);
                System.out.println("Player two got it right (Player 2) ?"+ p2listRight);
                System.out.println("Player three got it right (Player 3)?"+ p3listRight);
                break;
            }
